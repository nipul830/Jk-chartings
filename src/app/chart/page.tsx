...
function ChartContent(){
 ...
 return <div className="h-[calc(100vh-56px)] min-h-0 flex flex-col bg-black overflow-hidden">
  ...
  <div className="h-7 shrink-0 border-t border-[#222] bg-[#080808] px-3 flex items-center justify-between text-[10px] text-[#777]"><span>JK Chartings • Live market data</span><span>{activeChart?.symbol||"BTCUSDT"} · {activeChart?.timeframe||"15m"}</span></div>
